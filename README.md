...
2.  Develop your plugin code in `src/dp_bear_v_89_alpha_new`

    The `src/dp_bear_v_89_alpha_new/Plugin.tsx` is the main plugin file where you have to register all
    your custom content. However, you can create as many new files as you want under the `src/dp_bear_v_89_alpha_new`
...
5.  Add plugin to one or more workspaces: `npm run add-plugin -- <url>`
    ...
    Run the `npm run add-plugin -- "https://your.hosting/pluginDirOfYourChoice/dp_bear_v_89_alpha_new.js"` to
...
6.  Use plugin on a dashboard: `npm run link-plugin -- <plugin-object-id>`
    ...
    If your plugin supports parameterization (see [src/dp_bear_v_89_alpha_new](./src/dp_bear_v_89_alpha_new/Plugin.tsx)) and
...
This project is setup so that all your custom code must be self-contained in the [src/dp_bear_v_89_alpha_new](./src/dp_bear_v_89_alpha_new) directory.

The [src/dp_bear_v_89_alpha_new\_engine](./src/dp_bear_v_89_alpha_new_engine) and [src/dp_bear_v_89_alpha_new\_entry](./src/dp_bear_v_89_alpha_new_entry) directories contain essential plugin boilerplate.
...
You can modify minEngineVersion and maxEngineVersion properties in `src/dp_bear_v_89_alpha_new\_entry/index`.
