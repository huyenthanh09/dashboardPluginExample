...
var BaseVisualization = /** @class */ (function (_super) {
    ...
    BaseVisualization.prototype.triggerExtendedReferencePointChanged = function (newProps, currentProps) {
        var _this = this;
        var newReferencePoint = newProps.referencePoint, onExtendedReferencePointChanged = newProps.onExtendedReferencePointChanged, onSortingChanged = newProps.onSortingChanged;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.visualization.getSortConfig(extendedReferencePoint)];
                        case 1:
                            sortConfig = _a.sent();
                            return [2 /*return*/, onSortingChanged && onSortingChanged(sortConfig)];
                    }
                });
            }); });
        }
