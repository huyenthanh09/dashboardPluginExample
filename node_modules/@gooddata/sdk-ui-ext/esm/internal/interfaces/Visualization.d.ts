...
import { IAnalyticalBackend, IExecutionFactory, IPreparedExecution, ISettings, ITheme } from "@gooddata/sdk-backend-spi";
import { IColorPalette, IInsight, IInsightDefinition, ITotal, ObjRef, VisualizationProperties, IExecutionConfig, LocalIdRef, ISortItem } from "@gooddata/sdk-model";
