...
export var getItemsTitles = function (selectedFilterOptions, elementTitles, isElementsByRef) {
    return selectedFilterOptions
        .map(function (selectedOption) {
        var _a;
        var key = isElementsByRef ? selectedOption.uri : selectedOption.title;
        return key
            ? (_a = elementTitles.get(key)) === null || _a === void 0 ? void 0 : _a.title : (selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.title) ? selectedOption.title
            : undefined;
    })
        .filter(function (title) { return !isEmpty(title); })
        .join(", ");
};
export var updateSelectedOptionsWithDataByMap = function (selection, validElements, isElementsByRef) {
    return selection.map(function (selectedItem) {
        var key = isElementsByRef ? selectedItem.uri : selectedItem.title;
...
export var updateSelectedOptionsWithData = function (selection, items) {
    ...
    if (isEmpty(items)) {
        return selection.map(function (item) {
            var _a, _b;
            return {
                title: (_a = item === null || item === void 0 ? void 0 : item.title) !== null && _a !== void 0 ? _a : "",
                uri: (_b = item === null || item === void 0 ? void 0 : item.uri) !== null && _b !== void 0 ? _b : "",
            };
        });
    }
    var createFullItem = function (item) {
        var _a, _b;
        return ({
            uri: (_a = item.uri) !== null && _a !== void 0 ? _a : "",
    ...
    return selection.map(function (selectedItem) {
        return (nonEmptyItems.find(function (item) {
            return ((selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.uri) && item.uri === selectedItem.uri) ||
                ((selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.title) && item.title === selectedItem.title);
