...
import { IntlWrapper, useCancelablePromise, usePlaceholder, usePrevious, useResolveValueWithPlaceholders, withContexts, } from "@gooddata/sdk-ui";
...
var DropdownButton = function (_a) {
    var isMobile = _a.isMobile, isOpen = _a.isOpen, title = _a.title, subtitleItemCount = _a.subtitleItemCount, subtitleText = _a.subtitleText, isFiltering = _a.isFiltering, isLoaded = _a.isLoaded;
...
export var AttributeFilterButtonCore = function (props) {
    ...
    useEffect(function () {
        setState(function (prevState) {
            return __assign(__assign({}, prevState), { validOptions: null, offset: 0, limit: LIMIT, needsReloadAfterSearch: true });
        });
    }, [state.searchString]);
    /*
    ...
    var uriToAttributeElementMapError = useCancelablePromise({
        promise: isEmpty(state.selectedFilterOptions)
            ...
            : function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, prepareElementsTitleQuery(state.appliedFilterOptions).query()];
            }); }); },
    ...
    var _j = useCancelablePromise({
        promise: needsLoading(state.validOptions, state.offset, state.limit) || state.needsReloadAfterSearch
            ? function () { return __awaiter(void 0, void 0, void 0, function () {
                var preparedElementQuery;
                return __generator(this, function (_a) {
                    preparedElementQuery = prepareElementsQuery(state.offset, state.limit, state.searchString);
    ...
    var prepareElementsQuery = function (offset, limit, filter) {
        ...
        var preparedElementQuery = getBackend()
            ...
            .withOptions(__assign({}, (!isEmpty(filter) ? { filter: filter } : {})))
            .withOffset(offset)
            .withLimit(limit);
    ...
    var prepareElementsTitleQuery = function (elements) {
        return getBackend()
            ...
            .forDisplayForm(getObjRef(currentFilter, props.identifier))
            .withOptions({
            uris: elements.map(function (opt) { return opt.uri; }),
        });
    };
    /**
     * getters
    ...
    var getSubtitle = function () {
        ...
        if (state.uriToAttributeElementMap.size > 0 && !isNil(originalTotalCount) && displayForm) {
             ...
             */
            var empty = getNumberOfSelectedItems(state.selectedFilterOptions, state.isInverted) === 0 &&
                originalTotalCount > 0;
            /**
             * All items are selected only in case the number of selected items is equal to original total
             * count.
             */
            var all = getNumberOfSelectedItems(state.selectedFilterOptions, state.isInverted) ===
                originalTotalCount;
            ...
            return state.isInverted
                ? getAllPartIntl + " " + getItemsTitles(state.selectedFilterOptions, state.uriToAttributeElementMap, isElementsByRef)
                : "" + getItemsTitles(state.selectedFilterOptions, state.uriToAttributeElementMap, isElementsByRef);
        }
        return "";
    };
    /**
    ...
    var getNumberOfSelectedItems = function (filterOptions, isInverted) {
        if (isInverted) {
    ...
    function renderDefaultBody(bodyProps, closeDropdown) {
        return isAllFiltered ? (React.createElement(MediaQuery, { query: MediaQueries.IS_MOBILE_DEVICE }, function (isMobile) { return (React.createElement(AttributeDropdownAllFilteredOutBody, { parentFilterTitles: parentFilterTitles, onApplyButtonClick: function () {
            ...
            }, onCancelButtonClick: closeDropdown, isMobile: isMobile })); })) : hasNoData ? (React.createElement(NoData, { noDataLabel: props.intl.formatMessage({ id: "attributesDropdown.noData" }) })) : (React.createElement(AttributeDropdownBody, __assign({}, bodyProps, { isMobile: bodyProps.isFullWidth })));
    }
    var renderAttributeDropdown = function () {
        var getDropdownBodyProps = function (onApplyButtonClicked, onCloseButtonClicked, isMobile) {
            ...
            return ({
                ...
                showItemsFilteredMessage: showItemsFilteredMessage(isElementsLoading(), resolvedParentFilters) && !isAllFiltered,
        ...
        return (React.createElement(Dropdown, { closeOnParentScroll: true, closeOnMouseDrag: true, closeOnOutsideClick: true, enableEventPropagation: true, alignPoints: [
                ...
                return (React.createElement(MediaQuery, { query: MediaQueries.IS_MOBILE_DEVICE }, function (isMobile) { return (React.createElement("span", { onClick: toggleDropdown },
                    React.createElement(DropdownButton, { isFiltering: state.isFiltering, isOpen: state.isDropdownOpen, isMobile: isMobile, title: props.title ||
                            (attributeStatus !== "loading" && attributeStatus !== "pending")
                            ? attribute.title
                            : getLoadingTitleIntl(props.intl), subtitleText: getSubtitle(), subtitleItemCount: state.selectedFilterOptions.length, isLoaded: !isOriginalTotalCountLoading() }))); }));
                ...
                return (React.createElement(MediaQuery, { query: MediaQueries.IS_MOBILE_DEVICE }, function (isMobile) {
                    ...
                    return props.renderBody
                        ? props.renderBody(__assign(__assign({}, getDropdownBodyProps(function () {
                            ...
                            closeDropdown();
                        })), { isElementsLoading: !((_a = state.validOptions) === null || _a === void 0 ? void 0 : _a.items) && isElementsLoading(), isLoaded: !isOriginalTotalCountLoading(), onConfigurationChange: noop, attributeFilterRef: null, isMobile: isMobile }))
